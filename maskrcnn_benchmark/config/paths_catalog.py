...
class DatasetCatalog(object):
    ...
    DATASETS = {
        ...
        "voc_2012_train_aug_cocostyle": {
            "img_dir": "Dataset/VOC2012_SEG_AUG/JPEGImages",
            "ann_file": "Dataset/VOC2012_SEG_AUG/voc_2012_train_aug.json"
        },

        "voc_2012_train_aug_cocostyle_BBAM_fg_85_ignore_2_mcg": {
            "img_dir": "Dataset/VOC2012_SEG_AUG/JPEGImages",
            "ann_file": "BBAM_training_images_nimg_10582_th_0.85_plus_mcg.json",
            "ann_file_ignore": "BBAM_training_images_nimg_10582_th_0.2_plus_mcg.json"
        },
        ...
        "voc_2012_val_cocostyle": {
            "img_dir": "Dataset//VOC2012_SEG_AUG/JPEGImages",
            "ann_file": "Dataset/VOC2012_SEG_AUG/voc_2012_val_cocostyle.json"
        },
        "voc_2012_test": {
    ...
    def get(name):
        if "coco" in name:
            ...
            if "ann_file_ignore" in attrs.keys():
                args = dict(
                    root=os.path.join(data_dir, attrs["img_dir"]),
                    ann_file=os.path.join(data_dir, attrs["ann_file"]),
                    ann_file_ignore=os.path.join(data_dir, attrs["ann_file_ignore"]),
                )
                return dict(
                    factory="COCODataset",
                    args=args,
